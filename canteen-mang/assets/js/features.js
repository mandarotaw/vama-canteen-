    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">VaMa</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">VaMa</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Chetana college is good for the studies of information technology</p>
                        <ul class="py-1">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://www.chetanacollege.in/" target="_blank">Chetana college</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91000000000</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@chetanacollege.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Mumbai, Maharashtra 400050</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: https://www.chetanacollege.in/</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Vansh & Mandar</a></div>
                </main>
            </section>
        `;
        })
        ...
        userFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        <h1 class="sm">about</h1>
                        <p>Chetana college provides high quality eduaction in the field of IT</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/" target="_blank">Instagram</a></li>
                        </ul>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://github.com/rvutd/" target="_blank">Git Repository</a></li>
                            <li><a href="https://www.chetanacollege.in/" target="_blank">Chetana college</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-000000000</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@chetanacollege.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Mumbai, Maharashtra 400050
                            </p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: https://www.chetanacollege.in/</p></li>
                        </ul>
                    </article>
